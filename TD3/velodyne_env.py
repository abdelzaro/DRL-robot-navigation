...
class GazeboEnv:
    ...
    def gaps_callback(self, msg):
        ...
        max_range = 5.0  # Max sensor range (adjust if needed)
        ...
        gap_vector = gaps_flat[:max_gaps * 4]# #IF YOU CHANGE THIS!!!: update dgap_number_gaps_dim in train_velodyne_td3.py
