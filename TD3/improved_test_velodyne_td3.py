...
environment_dim = 20
robot_dim = 4
dgap_number_gaps_dim = 10 * 4 # 5 gaps * 4 floats in the dgap_flat_list
env = GazeboEnv("multi_robot_scenario.launch", environment_dim)
time.sleep(5)
torch.manual_seed(seed)
np.random.seed(seed)
state_dim = robot_dim + dgap_number_gaps_dim #IMPORTANT CHANGE FOR NO LIDAR!! REMOVE environment_dim!
